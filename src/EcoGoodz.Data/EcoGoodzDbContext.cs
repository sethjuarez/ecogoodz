    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Buyer>(entity =>
        {
            ...
            entity.Property<string>("NameSort")
                .HasComputedColumnSql("CONVERT(nvarchar(450), [Name])");
        ...
        modelBuilder.Entity<PackageType>(entity =>
        {
            ...
            entity.Property(e => e.CreateOn).HasColumnType("datetime");
            entity.Property<string>("TypeSort").HasComputedColumnSql("CONVERT(nvarchar(450), [Type])");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.CreateOn).HasColumnType("datetime");
            entity.Property<string>("NameSort").HasComputedColumnSql("CONVERT(nvarchar(450), [Name])");

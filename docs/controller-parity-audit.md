...
| `SupplierProductController` | `SupplierProductController`, `BuyerSupplierController` | **Core complete; wizard/history gaps** | Supplier product CRUD and supplier rate management are rebuilt. Not rebuilt: supplier-product-to-buyer wizard, supplier product history table, bulk supplier-location product update, and assignment wizard surfaces. |

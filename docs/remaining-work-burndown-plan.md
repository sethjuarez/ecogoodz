...
| 2 | Trading setup accelerators | Supplier-product-to-buyer wizard (**done**), recent-load widgets (**done**), supplier tracking product/supplier helpers (**done**), buyer tracking helpers | Relationship/product setup can be done with the same few-click paths as legacy where still useful. |

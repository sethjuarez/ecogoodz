...
| 6 | Low-priority helpers | Location favorite toggle (**done**), load export, favorite list filters, quick status/substatus helpers | Implement only if users confirm the workflow still matters. |

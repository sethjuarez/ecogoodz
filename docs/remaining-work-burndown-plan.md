...
| 3 | Rate/history power tools | Rate history tables (**done**), supplier-rate propagation to tied buyer/supplier products | Rate changes are auditable and bulk updates avoid manual re-entry. |

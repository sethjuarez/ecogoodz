...
|---:|---|---|---|
| 1 | Operational data-entry accelerators | Location copy (**done**), contact copy (**done**), task multi-assignee create (**done**), task headline board parity | Staff can perform the high-frequency data-entry shortcuts that existed in legacy. |
